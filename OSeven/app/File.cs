...
namespace OSeven.files
{
    public static class Files
    {
        ...
        public static void Run()
        {
            ...
            try
            {
                if (VFSManager.GetFileSystemLabel(seldisk + ":\\") == null)
                {
                    ;
                }
            }
        ...
        diskselected:
            ...
            switch (inputfile)
            {
                case "help":
                    ...
                    Console.WriteLine(" ---------------------------------------");
                    Console.ResetColor();
                    Console.WriteLine("|  info   |         Infromation          |");
                    Console.WriteLine("|  cd     |         createdisk           |");
                    Console.WriteLine("|  q      |         Quit App             |");
                    Console.WriteLine("| mkdir   |         Make directory       |");
                    Console.WriteLine("| dir     |         Diirectory           |");
                    Console.WriteLine("| deldir  |         Delete Directory     |");
                    Console.WriteLine("| format  |         Format               |");
                    Console.WriteLine("| system  |         return               |");
                    Console.WriteLine(" ----------------------------------------");
        ...
        public static void Check()
        {
            try
            {
                ...
                Console.Write("| .. |");
                Console.ResetColor();
                Console.Write(" OSeven File Manager");
